...
image_interface = gr.Interface(
    ...
    live=True,
    title="Face Models Comparison",
    description="Compare face landmark detection using MediaPipe and Torchlm models"
)
...
video_interface = gr.Interface(
    ...
    title="Face Models Comparison - Video",
    description="Compare face landmark detection using MediaPipe and Torchlm models on video"
)
